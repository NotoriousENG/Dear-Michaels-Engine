...
namespace rm
{
	rm::Mesh::Mesh(vector<Vertex> vertices, vector<unsigned int> indices, vector<std::shared_ptr<rm::Texture2D>> textures, const char* name)
	{
		this->vertices = vertices;
		this->indices = indices;
		this->material = std::make_shared<rm::Material>();

		this->material->Shader = rm::ResourceManager::Load<rm::Shader>(material->ShaderPath);
